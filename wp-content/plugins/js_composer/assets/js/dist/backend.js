...
window.vc || (window.vc = {}),
        ...
        _.isUndefined(window.vc) && (window.vc = {}), window.Vc_postSettingsEditor = Backbone.View.extend({
            ...
            setSizeResizable: function() {
                var $editor = $("#" + this.sel),
                    ...
                    height = vc.active_panel.$el.find('[data-vc-ui-element="panel-footer"]').offset().top - editorPositionTop - 70;
        ...
        _.isUndefined(window.vc) && (window.vc = {}), vc.showSpinner = function() {
            ...
            createElement: function(e) {
                ...
                if (!this.preventDoubleExecution) {
                    ...
                    var newData, mapped = vc.getMapped(tag);
            ...
            createElement: function(e) {
                var that, row_inner_params, column_inner_params, column, row, tag, row_params, column_params, model;
                this.preventDoubleExecution || (this.preventDoubleExecution = !0, e && e.preventDefault && e.preventDefault(), this.do_render = !0, tag = $(e.currentTarget).data("tag"), row_params = {}, model = !(column_params = {
                    width: "1/1"
            ...
            changeTab: function(e) {
                var $tab;
                e && e.preventDefault && e.preventDefault(), e.target && this.$tabs && ($tab = $(e.target), this.$tabs.find(".vc_active").removeClass("vc_active"), $tab.parent().addClass("vc_active"), this.$el.find($tab.data("target")).addClass("vc_active"), window.setTimeout(this.setTabsSize, 100))
            },
            showMessage: function(text, type) {
            ...
            removeTemplate: function(e) {
                ...
                var template_id, template_type, template_action, $template = $(e.target).closest("[data-template_id]"),
                    template_name = $template.find('[data-vc-ui-element="template-title"]').text();
                confirm(window.i18nLocale.confirm_deleting_template.replace("{template_name}", template_name)) && (template_id = $template.data("template_id"), template_type = $template.data("template_type"), template_action = $template.data("template_action"), $template.remove(), $.ajax({
                    type: "POST",
                    url: window.ajaxurl,
                    data: {
                ...
                try {
                    ...
                    if ($wrapper.hasClass("vc_active") || $wrapper.hasClass("vc_loading")) $el.vcAccordion("collapseTemplate");
                        ...
                        $el.vcAccordion("collapseTemplate", function() {
                            var question, $frame, templateId = $wrapper.data("template_id"),
                            ...
                            templateId && !localContentChilds && (question = "?", -1 < window.ajaxurl.indexOf("?") && (question = "&"), url = window.ajaxurl + question + $.param({
                                ...
                                post_id: vc_post_id,
                                _vcnonce: window.vcAdminNonce
                            }), $el.find("i").addClass("vc_ui-wp-spinner"), _this.$content.html('<iframe style="width: 100%;" data-vc-template-preview-frame="' + templateId + '"></iframe>'), ($frame = _this.$content.find("[data-vc-template-preview-frame]")).attr("src", url), $wrapper.addClass("vc_loading"), $frame.on("load", function() {
    ...
    function($) {
        ...
        window.vc.element_start_index = 0, window.vc.AddElementUIPanelBackendEditor = vc.PanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).extend({
            ...
            createElement: function(e) {
                var options, model, column, row, showSettings, row_params, inner_row_params, column_params, inner_column_params, tag, $control, preset, presetType, closestPreset, modelOptions, rowOptions, columnOptions;
                e && e.preventDefault && e.preventDefault(), tag = ($control = $(e.currentTarget)).data("tag"), row_params = {}, column_params = {
                    width: "1/1"
                }, (closestPreset = $control.closest("[data-preset]")) && (preset = closestPreset.data("preset"), presetType = closestPreset.data("element")), !1 === this.model ? (window.vc.storage.lock(), "vc_section" === tag ? (modelOptions = {
                    shortcode: tag
                }, preset && "vc_section" === presetType && (modelOptions.preset = preset), model = vc.shortcodes.create(modelOptions)) : (rowOptions = {
                    shortcode: "vc_row",
                    params: row_params
                }, preset && presetType === tag && (rowOptions.preset = preset), columnOptions = {
                    shortcode: "vc_column",
                    params: column_params,
                    ...
                    order: this.prepend ? this.getFirstPositionIndex() : vc.shortcodes.getNextOrder(),
                    root_id: this.model.get("root_id")
                }, preset && presetType === tag && (options.preset = preset), vc.shortcodes.create(options)), this.model = model, showSettings = !(_.isBoolean(vc.getMapped(tag).show_settings_on_create) && !1 === vc.getMapped(tag).show_settings_on_create), this.model.get("shortcode"), this.hide(), showSettings && this.showEditForm()
            },
            getFirstPositionIndex: function() {
            ...
            createElement: function(e) {
                var options, showSettings, newData, i, column_params, row_params, inner_row_params, inner_column_params, $control, tag, preset, presetType, closestPreset, modelOptions, rowOptions, columnOptions;
                for (e && e.preventDefault && e.preventDefault(), tag = ($control = $(e.currentTarget)).data("tag"), row_params = {}, column_params = {
                        width: "1/1"
                    }, (closestPreset = $control.closest("[data-preset]")) && (preset = closestPreset.data("preset"), presetType = closestPreset.data("element")), this.prepend && (window.vc.activity = "prepend"), 0 == this.model ? "vc_section" === tag ? (modelOptions = {
                        shortcode: tag
                    }, preset && "vc_section" === presetType && (modelOptions.preset = preset), this.builder.create(modelOptions)) : (rowOptions = {
                        shortcode: "vc_row",
                        params: row_params
                    }, preset && "vc_row" === presetType && (rowOptions.preset = preset), this.builder.create(rowOptions), columnOptions = {
                        shortcode: "vc_column",
                        parent_id: this.builder.lastID(),
                        params: column_params
            ...
            showSaveTemplateDialog: function() {
                ...
                this.fetchSaveTemplateDialog(function(created) {
                    var delay, $btn, $tab = _this.$el.find(".vc_ui-panel-content-container"),
                        ...
                        $title = $prompt.find(".textfield");
                    $tab.find(".vc_ui-prompt.vc_visible").removeClass("vc_visible"), $prompt.addClass("vc_visible"), $title.focus(), $tab.addClass("vc_ui-content-hidden"), created && (delay = 0, $btn = $prompt.find("#vc_ui-save-templates-btn"), $prompt.on("submit", function() {
                        var title = $title.val();
    ...
    function($) {
        ...
        window.vc.TemplateLibraryView = vc.PanelView.vcExtendUI(vc.HelperAjax).extend({
            ...
            deleteTemplate: function(data) {
                var index;
                "shared_templates" !== data.type || -1 !== (index = _.findIndex(this.myTemplates, {
                    post_id: data.id
    ...
    function(vc, _, $) {
        ...
        window.vc_toTitleCase = function(str) {
            ...
            for (i in numbers_sum = 0, columns) {
                !isNaN(parseFloat(columns[i])) && isFinite(columns[i]) && (sp = columns[i].match(/(\d{1,2})(\d{1,2})/), numbers_sum = _.reduce(sp.slice(1), function(memo, num) {
            ...
            if ("new" !== action && "clone" !== action || $elem.find(".vc_control.column_toggle").click(), "new" === action) {
                for (var random, colors, exclude = ["white", "black"], $select = $elem.find("[name=values_color]"), $options = $select.find("option"), i = 0; !(100 < i++);)
            ...
            var params;
            !value || (params = model.get("params")) && params.css && (params.css = params.css.replace(/(background(\-position)?\s*\:\s*[\S]+(\s*[^\!\s]+)?)[\s*\!important]*/g, "$1"), model.set("params", params, {
                silent: !0
            }))
    ...
    function($) {
        ...
        window.init_textarea_html = function($element) {
            var textfield_id, $form_line, $content_holder, $wp_link = $("#wp-link");
            $wp_link.parent().hasClass("wp-dialog") && $wp_link.wpdialog("destroy"), textfield_id = $element.attr("id"), $content_holder = ($form_line = $element.closest(".edit_form_line")).find(".vc_textarea_html_content");
            try {
        ...
        var VcLoopEditorView = Backbone.View.extend({
                ...
                updateSuggestion: function($elem, data) {
                    var $suggestion_block = $elem.closest("[data-block=suggestion]"),
            ...
            VcOptionsField = Backbone.View.extend({
                ...
                render: function() {
                    ...
                    return _.each(this.settings, function(field) {
                        ...
                        var template, $field = $("#vcl-options-field-" + field.type);
                        $field.is("script") && (template = vc.template($field.html(), vc.templateOptions.custom), html += template(_.extend({}, {
                            name: "",
                            label: "",
                            value: [],
                            options: "",
                ...
                parseData: function() {
                    _.each(this.$input.val().split("|"), function(data) {
                        ...
                        data.match(/\:/) && (name = (split = data.split(":"))[0], value = split[1], this.data[name] = _.map(value.split(","), function(v) {
                ...
                save: function(e) {
                    var value, $field = $(e.currentTarget);
        ...
        var GoogleFonts = Backbone.View.extend({
            ...
            VC_ParamGroup_Param = Backbone.View.extend({
                ...
                hookAdminLabel: function(e) {
                    for (var paramSettings, labelName = "", labelValue = "", labels = [], $parent = ($field = $(e.currentTarget)).closest(".vc_param_group-wrapper"), $wrapperLabel = $field.closest(".vc_param").find(".vc_param-group-admin-labels"), i = 0; i < this.adminLabelParams.length; i++) {
                ...
                hookDependent: function(e) {
                    ...
                    return $masterContainer.hasClass("vc_dependent-hidden") ? _.each(dependentElements, function($element) {
                        ...
                        var event, paramName = $element.attr("name"),
                        ...
                        _.isBoolean(rules.not_empty) && !0 === rules.not_empty && !isMasterEmpty || _.isBoolean(rules.is_empty) && !0 === rules.is_empty && isMasterEmpty || rules.value && _.intersection(_.isArray(rules.value) ? rules.value : [rules.value], _.isArray(masterValue) ? masterValue : [masterValue]).length || rules.value_not_equal_to && !_.intersection(_.isArray(rules.value_not_equal_to) ? rules.value_not_equal_to : [rules.value_not_equal_to], _.isArray(masterValue) ? masterValue : [masterValue]).length ? $paramBlock.removeClass("vc_dependent-hidden") : $paramBlock.addClass("vc_dependent-hidden"), (event = $.Event("change")).extra_type = "vcHookDependedParamGroup", $element.trigger(event)
                    }, this), this
                },
                ...
                clone: function(ev) {
                    var param, $content, value;
                    ev.preventDefault(), this.options.parent.addAllowed() && (param = this.options.parent.$ul.data("settings"), $content = this.$content, this.$content = this.$el, value = vc.atts.param_group.parseOne.call(this, param), $.ajax({
                        type: "POST",
                        url: window.ajaxurl,
                        data: {
        ...
        vc.edit_form_callbacks = [], vc.atts = {
            parse: function(param) {
                var params, $field = this.content().find(".wpb_vc_param_value[name=" + param.param_name + "]"),
            ...
            parse: function(param) {
                var $content = this.content(),
                    ...
                    data = vc.atts.param_group.extractValues.call(this, param, $('>.wpb_vc_row:not(".vc_param_group-add_content-wrapper")', $list));
            ...
            extractValues: function(param, $el) {
                ...
                return $el.each(function() {
                    ...
                    self.$content = $(this), _.each(param.params, function(par) {
                        var value, innerParam = $.extend({}, par),
            ...
            init: function(param, $field) {
                ...
                $('[data-vc-action="open"]', _this.content).on("click", function(e) {
                    ...
                    var value = $field_input.val(),
                        iframeURL = window.wpbGutenbergEditorUrl ? window.wpbGutenbergEditorUrl : "/wp-admin/post-new.php?post_type=wpb_gutenberg_param";
    ...
    function($) {
        ...
        vc.debug = !1, vc.map = _.isUndefined(window.vc_mapper) ? {} : window.vc_mapper, vc.roles = _.isUndefined(window.vc_roles) ? {} : window.vc_roles, vc.Storage = function() {
            ...
            storageCreateShortcodeString: function(model) {
                var mapped, data, content, isContainer, tag = model.get("shortcode"),
            ...
            _storageGetShortcodeContent: function(parent) {
                var params, models = _.sortBy(_.filter(this.data, function(model) {
    ...
    function() {
        ...
        vc.shortcode = Backbone.Model.extend({
            ...
            createFromString: function(shortcodes_string, parent_model) {
                var data = vc.storage.parseContent({}, shortcodes_string, !!_.isObject(parent_model) && parent_model.toJSON());
            ...
            _getShortcodeContent: function(parent, state) {
                var params, models = _.sortBy(vc.shortcodes.where({
    ...
    function($) {
        ...
        vc.clone_index = 1, vc.shortcode_view = Backbone.View.extend({
            ...
            _callJsCallback: function() {
                var fn, tag = this.model.get("shortcode");
                _.isObject(vc.map[tag]) && _.isObject(vc.map[tag].js_callback) && !_.isUndefined(vc.map[tag].js_callback.init) && (fn = vc.map[tag].js_callback.init, window[fn](this.$el))
            },
            ready: function(e) {
            ...
            changeShortcodeParams: function(model) {
                var view, tag = model.get("shortcode"),
                    params = model.get("params"),
                    settings = vc.map[tag];
                _.defer(function() {
            ...
            cloneModel: function(model, parent_id, save_order) {
                var new_order = _.isBoolean(save_order) && !0 === save_order ? model.get("order") : parseFloat(model.get("order")) + vc.clone_index,
                    params = _.extend({}, model.get("params")),
    ...
    function($) {
        ...
        vc.saved_custom_css = !1, vc.createPreLoader = function() {
            ...
            getView: function(model) {
                var view = _.isObject(vc.map[model.get("shortcode")]) && _.isString(vc.map[model.get("shortcode")].js_view) && vc.map[model.get("shortcode")].js_view.length && !_.isUndefined(window[window.vc.map[model.get("shortcode")].js_view]) ? new(window[window.vc.map[model.get("shortcode")].js_view])({
                    model: model
            ...
            appendShortcode: function(model) {
                var parentModelView, view = this.getView(model),
            ...
            addShortcode: function(model) {
                var view, parentModelView, _this, params = _.extend(vc.getDefaults(model.get("shortcode")), model.get("params"));
                model.set("params", params, {
                    silent: !0
            ...
            updateRowsSorting: function(e, ui) {
                _.defer(function(app) {
                    var oldParentId, parentNode = ui.item.parent(),
                    ...
                    vc.check_relevance(parent_tag, tag) && parent_tag != tag ? (oldParentId = model.get("parent_id"), parentNode.find(app.rowSortableSelector).each(function() {
    ...
    function($) {
        ...
        window.VcRowView = vc.shortcode_view.extend({
            ...
            buildDesignHelpers: function() {
                var image, color, rowId, matches, css = this.model.getParam("css"),
            ...
            setColumns: function(e) {
                ...
                var $parent, $button = $(e.currentTarget);
            ...
            buildDesignHelpers: function() {
                var image, color, elId, matches, css = this.model.getParam("css"),
                    $elementToPrepend = this.$el.find(this.designHelpersSelector);
                ...
                vc_user_access().partAccess("dragndrop") && (_this = this).$content.sortable({
                    ...
                    update: function(event, ui) {
                        ...
                        $elements.each(function() {
                            var parent, old_parent_id, model = $(this).data("model"),
                                index = $(this).index();
                            model.set("order", index), $elements.length - 1 > index && vc.storage.lock(), _.isNull(ui.sender) || (parent = ui.item.parent().closest("[data-model-id]").data("model"), old_parent_id = model.get("parent_id"), vc.storage.lock(), model.save({
                                parent_id: parent.id
		...
		window.VcNestedAccordionTabView = window.VcColumnView.extend({
            ...
            addTab: function(e) {
                if (e && e.preventDefault && e.preventDefault(), !vc_user_access().shortcodeAll("vc_tab")) return !1;
            ...
            changedContent: function(view) {
                var $tab_controls, $new_tab, params = view.model.get("params");
            ...
            cloneModel: function(model, parent_id, save_order) {
                var model_clone, new_order = _.isBoolean(save_order) && !0 === save_order ? model.get("order") : parseFloat(model.get("order")) + vc.clone_index,
                    params = _.extend({}, model.get("params")),
                    tag = model.get("shortcode");
		...
		window.VcNestedTabView = window.VcColumnView.extend({
            ...
            changedContent: function(view) {
                var changedContent = window.VcBackendTtaViewInterface.__super__.changedContent.call(this, view);
            ...
            removeSection: function(model) {
                var $viewTab = this.findSection(model.get("id"));
    ...
    function($, _) {
        ...
        attachmentCompatRender = _.extend(media.view.AttachmentCompat.prototype.render), media.view.AttachmentCompat.prototype.render = function() {
            ...
            $(".media-modal").addClass("processing-media"), processImages(selection, function(newAttachments) {
                var objects, attachments = _.map(newAttachments, function(newAttachment) {
    ...
    function($) {
        ...
        $(function() {
            ...
            window.vc && window.vc.events && ($undoControl = $("#vc_navbar-undo"), $redoControl = $("#vc_navbar-redo"), checkControls = function() {
                ...
                var newContent;
                $(this).is("[disabled]") || window.vc.undoRedoApi.isLocked() ? e && e.preventDefault && e.preventDefault() : (vc.closeActivePanel(), window.vc.undoRedoApi.lock(), newContent = window.vc.undoRedoApi.undo(), renderNewContent(newContent))
            }), $redoControl.on("click.vc-redo", function(e) {
                var newContent;
                $(this).is("[disabled]") || window.vc.undoRedoApi.isLocked() ? e && e.preventDefault && e.preventDefault() : (vc.closeActivePanel(), window.vc.undoRedoApi.lock(), newContent = window.vc.undoRedoApi.redo(), renderNewContent(newContent))
            }))
        })
    }(window.jQuery);