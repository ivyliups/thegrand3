...
// @booloolab
// https://www.isitwp.com/automatically-categorize-and-tag-posts-when-saved/
...
// add a category
$doctors_category = wp_get_post_categories( $post_id );
$newcat    = get_term_by( 'name', 'Some Category', 'category' );

array_push( $doctors_category, $newcat->term_id );
wp_set_post_categories( $post_id, $doctors_category );
}
